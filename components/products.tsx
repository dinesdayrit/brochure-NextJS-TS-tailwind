  ...
  return (
    <div className="mt-16 flex flex-col items-center" id="products">
      ...
      <div className="grid grid-cols-2 gap-4 mt-6">
        <Image src="/p1.png" width={500} height={500} alt="Product 1" onClick={() => openModal("/p1.png")} priority/>
        <Image src="/p2.png" width={500} height={500} alt="Product 2" onClick={() => openModal("/p2.png")} priority/>
        <Image src="/p3.png" width={500} height={500} alt="Product 3" onClick={() => openModal("/p3.png")} priority/>
        <Image src="/p4.png" width={500} height={500} alt="Product 4" onClick={() => openModal("/p4.png")} priority/>
        <Image src="/p5.png" width={500} height={500} alt="Product 5" onClick={() => openModal("/p5.png")} priority/>
        <Image src="/p6.png" width={500} height={500} alt="Product 6" onClick={() => openModal("/p6.png")} priority/>
      </div>
